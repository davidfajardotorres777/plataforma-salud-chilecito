...
class SaludHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        try:
            ...
            if self._handle_post_store(route, payload): return
            if self._handle_post_auth_keys(route, payload): return
            if self._handle_post_webhooks(route, payload): return
            if self._handle_post_auth_pacientes(route, payload): return
    ...
    def _handle_post_store(self, route: str, payload: dict) -> bool:
    ...
    def _handle_post_auth_keys(self, route: str, payload: dict) -> bool:
    ...
    def _handle_post_webhooks(self, route: str, payload: dict) -> bool:
    ...
    def _handle_post_auth_pacientes(self, route: str, payload: dict) -> bool:
